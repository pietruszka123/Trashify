    ...
    <header class="dark:bg-gray-900 dark:text-green-100 text-pink-300 bg-indigo-800 h-16 w-full items-center overflow-hidden flex gap-2">
        ...
        <nav class="block relative w-max bg-transparent z-10 ml-auto mt-2 mr-5 ">
            ...
            <ul class="mainMenu m-3 rounded-2xl dark:bg-gray-900 bg-g1 flex flex-wrap gap-2 px-2">
                ...
                $beg = '/Konkurs4/php/';
                ?>
                <li class="flex justify-center rounded-3xl"><a href="index.php" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . 'index.php' == $URI) {
                                                                                                                                                        echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                    } ?>">Home</a></li>
                <li class="flex justify-center rounded-3xl"><a href="mapa.php" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . 'mapa.php' == $URI) {
                                                                                                                                                        echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                    } ?>">Mapa</a></li>
                <li class="flex justify-center rounded-3xl"><a href="blog.php" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . 'blog.php' == $URI) {
                                                                                                                                                        echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                    } ?>">Blog</a></li>
                <li class="flex justify-center rounded-3xl"><a href="informacje.php" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . 'informacje.php' == $URI) {
                                                                                                                                                                echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                            } ?>">Info</a></li>
                <li class="flex justify-center rounded-3xl"><a href="tworcy.php" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . 'tworcy.php' == $URI) {
                                                                                                                                                            echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                        } ?>">Twórcy</a></li>
                <li class="flex justify-center rounded-3xl mt-2"><a href="" class=" w-full text-center hover:bg-blue-500 dark:hover:bg-blue-500 <?php if ($beg . '.php' == $URI) {
                                                                                                                                                    echo 'dark:hover:text-white  bg-pink-400 dark:bg-blue-500';
                                                                                                                                                } ?>">wyloguj</a></li>
