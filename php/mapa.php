...
<div class="map w-80 h-fit gap-2 dark:bg-gray-700 bg-green-500 dark:border-white border-indigo-500 border-4 rounded-2xl border-solid flex flex-wrap p-3 relative">
    <!-- nagłówek -->
    ...
    <!-- mapa -->
    <div id="map" style="height: 18rem;" class="map w-full h-72 mapa">
        ...
        <div class=" w-fit mx-auto flex justify-center dark:bg-gray-700 bg-green-500 text-left p-1 rounded-md">
            ...
            <div id="AddBinCont" class="flex flex-wrap w-fit" style="display: none;">
                <label class="flex w-full gap-2 items-center">
                    ...
                    <select id="type" class="focus:outline-none bg-gray-500 text-white font-bold p-1 rounded-md w-28 m-2 ">
                        <option value="mieszane" class="g-gray-900 focus:outline-none text-white">mieszane</option>
                        ...
                        <option value="leki" class="bg-red-700 focus:outline-none">
                            <p class="text-bold focus:outline-none">Lekarstwa +</p>
                        </option>
                    </select>
                </label>
                <input type="text" class="w-full h-10 p-3 m-2 dark:bg-gray-500 dark:text-white bg-white text-black focus:outline-none rounded-md text-xl placeholder-black" placeholder="longitude" id="longitude" pattern="[0-9.]+">
                <input type="text" id="latitude" pattern="[0-9.]+" placeholder="latitude" class="w-full h-10 p-3 m-2 dark:bg-gray-500 dark:text-white bg-white text-black placeholder-black focus:outline-none rounded-md text-xl">
                <!-- obrazek<input type="file" id=""> -->

                <!-- dodatkowe informacje<textarea id="" cols="30" rows="10" required></textarea> -->
                <button id="save" class="w-fit mx-auto h-fit p-3 m-2 dark:bg-gray-500 dark:text-white bg-gray-500 text-green-500 font-bold focus:outline-none rounded-xl pb-4 text-xl">Zapisz</button>
            </div>
        </div>
    </label>
</div>
