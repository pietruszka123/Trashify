...
<!-- skaner -->
<div class="my-3 z-0 w-80 h-fit dark:bg-gray-700 bg-green-400 dark:border-white border-4 rounded-2xl border-solid relative border-gray-600">
    <!-- info -->
    <button data-modal-target="#modal"><i class="ml-2 fas fa-info-circle text-3xl text-white absolute top-2 right-10 z-10"></i></button>
...
<div id="productInfoEdit" class="relative z-0 my-3 flex flex-wrap gap-2 dark:bg-gray-700 bg-green-400 p-4 border-4 border-solid dark:border-white rounded-2xl border-gray-600 w-80 h-fit" style="display: none;">
    <!-- NAZWA -->
